...
create table apc_qa(
	...
	qa_orderno number(5),						-- 취소/반품 관련 주문번호
...
-- 20220511 수정 : qa_orderno 추가
-- 20220512 수정 : qa_orderno 다시 제거 , pno 외래키 해제
...
insert into apc_qa 
values (11, 'DEL', 'apcceo', '배송문의', '4월28일에 주문했는데 배송일정이 어떻게되나요? 빨리보내주세요', 2, '1111', default, sysdate, '', 5, 1, 1);
insert into apc_qa 
