...
<body>
	...
	<jsp:include page="../include/admin_top.jsp" />
	   ...
	   <div class="col-sm-8 col-sm-offset-3">
		<br><br><br>
        <div class="page-header" align="center"><h2>고객 문의사항 답변수정</h2></div>
        <br>
        
        <c:set var="dto" value="${modify }" />
          <form method="post"
			action = "<%=request.getContextPath() %>/admin_qa_reply_update_ok.do">
        	...
        	<colgroup>
        		...
        		<tr>
        			<th>답변 제목</th>
        			<td><input class="form-control" style="width:50%;" name="reply_title"
        				value="${dto.getQa_title() }"> </td>
        		</tr>
        		...
        		<tr>
        			<td colspan="2" align="center">
        				<input type="submit" value="답변수정" class="btn btn-primary">
