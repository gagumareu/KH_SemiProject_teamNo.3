...
public class CartDAO_origin {
	...
	private static CartDAO_origin instance = null;
	
	private CartDAO_origin() { }
	
	public static CartDAO_origin getInstance() {
		
		if(instance == null) {
			
			instance = new CartDAO_origin();
