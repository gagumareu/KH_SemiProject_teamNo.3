...
public class FrontController extends HttpServlet {
	...
	protected void service(HttpServletRequest request,
		...
		FileInputStream fis = 
				new FileInputStream("C:\\Users\\user\\git\\KH_SemiProjeckt_teamNo.3\\19_Project\\src\\com\\apc\\controller\\mapping.properties");
		...
		if(value.substring(0, 7).equals("execute")) {
			 ...
			 * 
			 * - newInstance() 메서드는 기본생성자를호출해서 객체를 생성하기 때문에
